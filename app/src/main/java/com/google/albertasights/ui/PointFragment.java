...
public class PointFragment extends Fragment {
    ...
    private boolean crashHappend = false;
...
//                }
            ...
            UiUtils.showToast(getActivity(), "Unfortunately, the app has been terminated by the Android system." +
                    "Loading it again.");
            crashHappend = false;
            UiUtils.getEditor(getActivity()).putBoolean(UiUtils.EMERGENT_TERMINATION, false).commit();
