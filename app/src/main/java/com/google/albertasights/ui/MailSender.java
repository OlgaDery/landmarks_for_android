...
public class MailSender {
    ...
    private static final String SMTP_AUTH_USER = "your.naviguide@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "Androgeny80!"; //password/secret
    ...
    public static void sendEmail(String to, String subject, String msg){
        ...
        String from = "your.naviguide@gmail.com"; //from
